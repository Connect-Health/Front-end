        ...
        <div className="w-full h-screen bg-white">
          ...
          <h2 className='text-center text-lg mt-3'>Fazer uma Publicação</h2>
            ...
            <div className='mt-10 w-4/5 mx-auto'>
                ...
                <button className='absolute left-1/2 -translate-x-1/2 mt-5 bottom-20 py-2 bg-azulsite w-[80%] rounded-lg font-bold text-white' onClick={handlePostar}>Enviar</button>
