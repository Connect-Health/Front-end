...
function Blocos(){
    return(
        ...
        max-md:hidden
        '>
            <div style={{backgroundImage: `url(${bloco_1})`}} className='w-[25%] h-80 bg-contain bg-no-repeat flex-col flex
            ...
            <div style={{backgroundImage: `url(${bloco_2})`}} className=' w-[25%] h-80 bg-contain bg-no-repeat flex-col flex
            max-md:w-[27%] max-md:h-auto
            '>
...
tudo no nosso Feed!</p>
            ...
            <div style={{backgroundImage: `url(${bloco_3})`}} className=' w-[25%] h-80 bg-contain bg-no-repeat flex-col flex'>
