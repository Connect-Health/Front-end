    ...
    return(
        <div className='flex w-full h-auto items-center justify-center gap-20 '>
            <div className='bg-bloco1 w-[25%] h-80 bg-contain bg-no-repeat flex-col flex'>
                ...
                <button className='bg-[#8269E0] w-[55%] rounded-full p-1 text-[15px] mt-16 mb-20 mr-16 self-center'>Conheça Mais!</button>
            </div>

            <div className='bg-bloco2 w-[25%] h-80 bg-contain bg-no-repeat'>
                
            </div>

            <div className='bg-bloco3 w-[25%] h-80 bg-contain bg-no-repeat'>
