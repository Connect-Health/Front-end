...
function BGHome(){
    ...
    return(
        <div className=''>
            ...
            <div className='w-[20%] h-auto p-5 bg-[#d3d3d3] backdrop-blur-xl rounded-2xl bg-opacity-50 absolute top-[35%] left-[2.7%] z-10' style={{ transform: `translateX(${-offset * .5}px)`}}>
