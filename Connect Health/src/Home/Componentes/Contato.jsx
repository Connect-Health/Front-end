...
function Contato(){
    return(
        <div className='max-md:mt-[1100px]'>
            <div className='w-[100%]'>
                <h1 id='contato' className='text-center text-3xl font-bold text-[#5855F2] dark:text-white
                max-md:text-xl
                '>Entre em contato conosco!</h1>
            </div>

            <div className='w-[90%] m-auto  mt-10 flex gap-40 items-center mb-24
            max-md:w-[95%] max-md:justify-cente max-md:flex-col max-md:gap-14
            '>
                ...
                '>
                    ...
                    max-md:w-[100%]
                    '>
                        <input placeholder='Nome' className='w-[70%] h-[10%] bg-gradi bg-opacity-0 border-b-2 border-white placeholder:text-white text-white focus:outline-none
                        max-md:w-[80%]
                        ' type="text"/>
                        <input placeholder='Email' className='w-[70%] h-[10%] bg-gradi bg-opacity-0 border-b-2 border-white placeholder:text-white text-white focus:outline-none
                        max-md:w-[80%]
                        ' type="email" maxLength={11}/>
