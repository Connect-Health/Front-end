  ...
  return (
    <div className='drop-shadow-lg w-[90%] pb-6 rounded-2xl mt-10 mx-auto mb-7 bg-white'>
        <div className=' ml-4 pt-4 flex gap-5 '>
            <p className='text-white bg-azulsite/50 w-14 h-14 font-bold rounded-full flex items-center justify-center'>5,0</p>
        ...
        <div className='flex justify-around  mt-5 items-center'>
            <p className='text-azulsite/70 text-lg font-semibold'>Avaliação</p>
