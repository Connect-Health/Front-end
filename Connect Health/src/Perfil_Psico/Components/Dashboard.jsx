    ...
    return (
        <div className="bg-white h-[94vh] w-[78%] rounded-lg mt-[2%] shadow-2xl">
            <div className="flex flex-col gap-2 ">
                ...
                <div className="flex">
                    <div style={{backgroundImage:'assets/peoplehug.png'}} className='bg-bghug bg-x bg-no-repeat  w-[15%] h-[20vh] ml-12 mt-10 flex flex-col gap-2 rounded-lg items-center justify-center'>
                        <div className="">
                    ...
                    <div style={{backgroundImage:'../../../assets/yoga.png'}} className='bg-bgyoga bg-cover w-[15%] h-[20vh] ml-12 mt-10 flex flex-col gap-2 rounded-lg items-center justify-center'>
                        <div className="">
                            <h1 className="text-2xl text-white text-center">Psicologia</h1>
                        </div>
                    </div>

                    <div style={{backgroundImage:'../../../assets/enterprise.png'}} className='bg-bgempresa bg-cover  w-[15%] h-[20vh] ml-12 mt-10 flex flex-col gap-2 rounded-lg items-center justify-center'>
                        <div className="">
