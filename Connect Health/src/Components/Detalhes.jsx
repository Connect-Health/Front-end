  ...
  return (
    <div className={`flex justify-between gap-14 mb-12 max-md:hidden ${props.pai}`}>
        ...
        <div className='text-center text-white mt-5 mb-5 w-1/3 ml-5 max-md:w-1/2 '>
            ...
            <p className='text-lg drop-shadow-md max-md:text-sm'>Nós oferecemos planos mensais e consultas avulsas a preços acessíveis, para tornar nossos serviços de consultoria em nutrição acessíveis a todos os interessados em investir em sua saúde e bem-estar.</p>
        </div>
