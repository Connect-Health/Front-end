    ...
    return (
        <div className=''>
            ...
            <div className="flex flex-col mt-4 mb-14 max-md:justify-center ">
                ...
                <Link to="/register">
                    <p className="font-bold text-2xl text-center">É um <span className='text-azulsite'>cliente?</span>?</p>
                </Link>
            </div>
            <div className='-mt-5'>
                ...
                <div className='flex  mx-auto h-auto px-5 py-2 rounded shadow-lg justify-center gap-14 bg-[#ebebeb] max-md:flex-col max-md:items-center max-md:px-0'>
                    ...
                    <form className=' flex w-auto px-3 py-2 rounded'>
                        <div className=' flex flex-col items-center justify-evenly '>
                            ...
                            <h1 className='text-xl font-bold text-azulsite mb-5'>Informações Profissionais</h1>

                            <label htmlFor="name" className="flex flex-col text-azulsite text-xl mb-3">
                                <span className="mb-1  text-azulsite text-xl"> Foto de Perfil*:</span>
                                <input
                                    type="text"
                                    id="Avatar"
                                    name="Avatar"
                            ...
                            <label htmlFor="name" className="flex flex-col text-azulsite text-xl mb-3">
                                <span className="mb-1  text-azulsite text-xl">Arquivo de seu certificado*:</span>
                                <input
                                    type="text"
                                    id="Certificado"
                                    name="Certificado"
