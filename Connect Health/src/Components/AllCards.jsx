        ...
        <div className='w-[75%] '>
            <div className='w-[90%] m-auto flex flex-col'>
                    <h2 className='mt-4 font-semibold text-2xl text-center text-nutri'>{profissional.nome} <span>
                      {profissional.sobrenome}</span></h2>
                        ...
                        {profissional.especialidade.lenght > 4 ? (
                          <ul>
                            {profissional.especialidade.map((especial) => (
                              <li key={especial} className='border w-fit rounded-lg px-2 bg-white'>{especial}</li>
                            ))}
                          </ul>
                        ) : (
                          <li className='flex flex-wrap bg-[#D7F2E0] py-3 rounded-xl px-2 gap-1 justify-center'>
                            {profissional.especialidade.slice(0, 4).map((especial) => (
                            <span className='border w-fit rounded-lg px-2 bg-white' key={especial}>{especial}</span>
                          ))}</li>
                        )
                      }
